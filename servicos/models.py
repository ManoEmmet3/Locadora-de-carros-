...
from .choices import Choicesaluguel
# Create your models here.


class aluguel(models.Model):
    titulo = models.CharField(max_length=3, choices=Choicesaluguel.choices)
...
class Servico(models.Model):
    ...
    categoria_manutencao = models.ManyToManyField(aluguel)
...
# nao esta funcionando , ver depois
